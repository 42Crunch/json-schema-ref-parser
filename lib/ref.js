...
const { MissingPointerError, InvalidPointerError, isHandledError, normalizeError } = require("./util/errors");
...
$Ref.prototype.resolve = function (path, options, friendlyPath, pathFromRoot) {
  ...
  try {
    ...
    if (err instanceof MissingPointerError) {
      // set source location for MissingPointerError as well, to highlight problem on the reference
      err.source = stripHash(pathFromRoot);
    }
